...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  try {
    ...
    const orderNumber = url.searchParams.get("orderNumber"); // #1001
      ...
      return json(
        {
          ...
          message: "No se encontró ninguna orden con ese número",
        },
        { status: 404, headers },
      );
    }
    ...
    console.log(
      `[API Order Status] Orden ${orderNumber} consultada para ${customerName}`,
    );
